$(document).ready(
		function() {
			...
			// 轮播图
			/*
			 * var tu=0; var spend=1000; $(".bnr-right").click(function(){
			 * dsq(); }); $(".bnr-left").click(function(){ tu--; if(tu<0){
			 * tu=4; $(".banner ul").css("left",-6000); } $(".banner
			 * ul").animate({"left":-tu*1200},spend); }); var
			 * time=setInterval(dsq,2000); function dsq(){ tu++; if(tu>5){ tu=1;
			 * $(".banner ul").css("left",0); } $(".banner
			 * ul").animate({"left":-tu*1200},spend); }
			 * $(".banner").hover(function(){ clearInterval(time); },function(){
			 * clearInterval(time); time=setInterval(dsq,2000); });
			 */
			// 轮播图 END
			...
			/* 我的订单(移入收藏夹) */
			$(".favorites .fa-left li").hover(
					function() {
						$(this).addClass('current').siblings().removeClass(
								'current');
						$(".fa-right .fa-r-con .fa-con-uls")
			...
			$("[uls1] li").click(
					function(event) {
						...
						$("[uls2=" + us1 + "] .ul1").eq($(this).index()).show()
								.siblings().hide();
					});
			...
			/* 数量加减 */
			$(".mid-sl .sl-right").click(
					function(event) {
						var vl = $(this).siblings("input").val();
						var dj = $(this).parent().siblings(".mid-dj").children(
								'span').text();
						if (vl > 0) {
							vl++;
							$(this).siblings("input").val(vl);
							$(this).parent().siblings(".mid-je").children(
									'span').text(dj * vl);
						}
					});
			$(".mid-sl .sl-left").click(
					function(event) {
						var vl = $(this).siblings("input").val();
						var dj = $(this).parent().siblings(".mid-dj").children(
								'span').text();
			...
			/* 积分商城 */
			$(".integral-left li").click(
					function(event) {
						$(this).addClass('int-current').siblings().removeClass(
								'int-current');
						var intli = $(this).index();
						$(".int-r-con .int-con-ul1").eq(intli).show().siblings(
								".int-con-ul1").hide();
					});
			/* 商城活动 */
			$(".integral-left li").click(
					function(event) {
						$(this).addClass('int-current').siblings().removeClass(
								'int-current');
						var intli = $(this).index();
						$(".int-r-con .int-con-ul2").eq(intli).show().siblings(
								".int-con-ul2").hide();
					});
			...
			$("[shuxing1] li").click(
					function(event) {
						$(this).addClass('current').siblings().removeClass(
								'current');
						$("[shuxingsw1] ul").eq($(this).index()).show()
								.siblings().hide();
					});
			$("[shuxing2] li").click(
					function(event) {
						$(this).addClass('current').siblings().removeClass(
								'current');
						$("[shuxingsw2] ul").eq($(this).index()).show()
								.siblings().hide();
					});
			$("[shuxing3] li").click(
					function(event) {
						$(this).addClass('current').siblings().removeClass(
								'current');
						$("[shuxingsw3] ul").eq($(this).index()).show()
								.siblings().hide();
					});
			/* 搜索列表页(有品牌) js */
			/*
			 * $("[ppgd]").click(function(event) { var ht = $(".hover-brand
			 * ul").css("height"); if(ht=="106px"){ $(".hover-brand
			 * ul").css('height','212'); }else if(ht!="106px"){ $(".hover-brand
			 * ul").css('height','106'); } });
			 */
			...
			// ////////////////////////////
			/*
			 * $("input").attr("checked",false); var a=0;
			 * $(".p1").children("input").click(function(){ if(a==0){
			 * $(".info-top").children("input").attr("checked",true)
			 * $(".info-mid").children("input").attr("checked",true)
			 * $(".quanxuan").children("input").attr("checked",true) a=1; b=c=1; }
			 * else{ $(".info-top").children("input").attr("checked",false)
			 * $(".info-mid").children("input").attr("checked",false)
			 * $(".quanxuan").children("input").attr("checked",false) a=0;
			 * b=c=0; } }); $(".quanxuan").children("input").click(function(){
			 * if(a==0){ $(".info-top").children("input").attr("checked",true)
			 * $(".info-mid").children("input").attr("checked",true)
			 * $(".p1").children("input").attr("checked",true) a=1; } else{
			 * $(".info-top").children("input").attr("checked",false)
			 * $(".info-mid").children("input").attr("checked",false)
			 * $(".p1").children("input").attr("checked",false) a=0; } }); var
			 * b=c=0; $(".info-top").children("input").click(function(){
			 * if(b==0){ $(this).children("input").attr("checked",true) b=1; }
			 * else{ if(a==1){ $(this).children("input").attr("checked",false)
			 * $(this).next(".info-mid").children("input").attr("checked",false)
			 * $(".p1").children("input").attr("checked",false) b=0; a=0; } }
			 * }); $(".info-mid").children("input").click(function(){ if(c==0){
			 * $(this).children("input").attr("checked",true) c=1; } else{
			 * if(a==1){ $(this).children("input").attr("checked",false)
			 * $(this).prev(".info-mid").children("input").attr("checked",false)
			 * $(".p1").children("input").attr("checked",false) c=0; a=0; } }
			 * });
			 * 
			 * var jishuqi1=$(".cart-con-info").length; var i1=i2=jishuqi1;
