...
<body style="position:relative;">
	...
	<div class="payment-interface w1200">
		<div class="pay-info">
			...
			<ul class="pay-yh">
				<li><input type="checkbox" value="" name="hobby"></input> <img
					src="statics/images/jiangheng.gif" />
				...
				<li><input type="checkbox" value="" name="hobby"></input> <img
					src="statics/images/jiangheng.gif" />
					<div style="clear:both;"></div></li>
				<li style="border-right:0; width:298px;"><input type="checkbox"
					value="" name="hobby"></input> <img
					src="statics/images/jiangheng.gif" />
					<div style="clear:both;"></div></li>
				<li><input type="checkbox" value="" name="hobby"></input> <img
					src="statics/images/jiangheng.gif" />
				...
				<li style="border-right:0; width:298px;"><input type="checkbox"
					...
					src="statics/images/jiangheng.gif" />
					<div style="clear:both;"></div></li>
				<li style="border-bottom:0;"><input type="checkbox" value=""
					name="hobby"></input> <img src="statics/images/jiangheng.gif" />
					<div style="clear:both;"></div></li>
				<li style="border-bottom:0;"><input type="checkbox" value=""
					name="hobby"></input> <img src="statics/images/jiangheng.gif" />
					<div style="clear:both;"></div></li>
				<li style="border-bottom:0;"><input type="checkbox" value=""
					name="hobby"></input> <img src="statics/images/jiangheng.gif" />
					<div style="clear:both;"></div></li>
				<li style="border-right:0;border-bottom:0; width:298px;"><input
					type="checkbox" value="" name="hobby"></input> <img
					src="statics/images/jiangheng.gif" />
					<div style="clear:both;"></div></li>
				<div style="clear:both;"></div>
			</ul>
		...
		<div class="pay-info">
			...
			<div class="pay-mima">
				...
				<div class="mima-ipt">
					<p>请输入支付密码：</p>
					<input type="password" class="passone"
						onkeypress="return event.keyCode>=48&&event.keyCode<=57"
						maxlength="1" style="border-left:1px solid #E5E5E5;" /><input
						type="password"
						onkeypress="return event.keyCode>=48&&event.keyCode<=57"
						maxlength="1" class="passtwo" /><input type="password"
						onkeypress="return event.keyCode>=48&&event.keyCode<=57"
						maxlength="1" class="passthree" /><input type="password"
						onkeypress="return event.keyCode>=48&&event.keyCode<=57"
						maxlength="1" class="passfour" /><input type="password"
						onkeypress="return event.keyCode>=48&&event.keyCode<=57"
						maxlength="1" class="passfive" /><input type="password"
						onkeypress="return event.keyCode>=48&&event.keyCode<=57"
						maxlength="1" class="passsix" /> <span>请输入6位数字支付密码</span>
				</div>
