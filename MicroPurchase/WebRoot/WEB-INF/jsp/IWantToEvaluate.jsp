...
<link rel="stylesheet" type="text/css" href="statics/css/star-rating.css" media="all"/>
...
<script type="text/javascript" src="statics/js/star-rating.js"></script>
<style type="text/css">
...
<body>
    ...
    <div class="evaluate w1200">
    	<dl class="eva-info1">
        	<dt><a href="#"><img src="statics/images/want-evaluate-tu.gif" /></a></dt>
            <dd>
        ...
        <div class="eva-info3">
        	<div class="eva-if3-l f-l">
            	...
            	<dl class="if3-l-dl3">
                    ...
                    <dd>
                    	<a href="JavaScript:;">
                        	<img src="statics/images/dl3-tu1.gif" />
                            <input type="file" class="img1" />
                        </a>
                        <a href="JavaScript:;">
                        	<img src="statics/images/dl3-tu2.gif" />
                            <input type="file" class="img1" />
                        </a>
                        <p>上传图片     1/5</p>
                        <div style="clear:both;"></div>
