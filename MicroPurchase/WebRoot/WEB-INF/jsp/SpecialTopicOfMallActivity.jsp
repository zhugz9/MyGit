...
<body>
    ...
    <div class="shopping-content w1200">
    	...
    	<div class="m-act-adver w1200">
        	<a href="#"><img src="statics/images/m-act-adverut.gif" /></a>
        </div>
        
    	<div class="sp-con-info">
        	<ul class="sp-info-r m-act">
                <li>
                    <a href="#"><img src="statics/images/m-act-con-firstli-tu.gif" /></a>
                </li>
                <li>
                    <div class="li-top">
                        <a href="#" class="li-top-tu"><img src="statics/images/beaut-con-li-tu2.gif" /></a>
    	...
    	<!--广告栏-->
    	<div class="m-act-adver w1200">
        	<a href="#"><img src="statics/images/m-act-adverut2.gif" /></a>
        </div>
    	...
    	<!--广告栏-->
    	<div class="m-act-adver w1200">
        	<a href="#"><img src="statics/images/m-act-adverut3.gif" /></a>
        </div>
    ...
    <ul class="youce">
    	<li class="li1">
        	<a href="index.html" class="li1-tu1"><img src="statics/images/zl2-94.png" /></a>
            <a href="index.html" class="li1-zi1">返回首页</a>
        </li>
        <li class="li2">
        	<a href="购物车.html"><img src="statics/images/zl2-95.png" />购</br>物</br>车</a>
        </li>
        <li class="li3">
        ...
        <li class="li3">
        	<a href="浏览记录.html" class="li1-tu2"><img src="statics/images/zl2-97.png" /></a>
